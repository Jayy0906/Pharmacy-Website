  ...
  const products = [
    {
      ...
      title: 'Hospital Bed',
      price: '$109.89',
      image: '/img/top-product-1.png',
    },
    {
      id: 2,
      title: 'Walker Mobility',
      price: '$12.80',
      image: '/img/top-product-2.png',
    },
    {
      id: 3,
      title: 'Wheelchair',
      price: '$30.00',
      image: '/img/top-product-3.png',
    },
    {
      id: 4,
      title: 'Crutches',
      price: '$24.78',
      image: '/img/top-product-4.png',
    },
  ];
  ...
  return (
    <section className="px-4 md:px-12 py-16 bg-gradient-to-br from-[#e0f7ec] via-white to-[#f0f9ff] rounded-t-4xl">
      <div className="flex justify-between items-center mb-10 flex-wrap gap-4">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">🌟 Top Products</h1>
